...
<head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="http://localhost/ujikom_avni/public/assets/css/style.css">
...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a class="nav-link" href ="http://localhost/ujikom_avni/app">
    ...
    <?php foreach($data['profile'] as $pro) : ?>
      <div class="jumbotron text-center pt-4" style="height: 500px">
          <img src="http://localhost/ujikom_avni/public/assets/img/<?= $pro['Image']; ?>" alt="" width="200" class="rounded-circle" data-aos="zoom-in=up" data-aos-duration="2000" />
           ...
           <div class="row justify-content-evenly fs-5">
              <div class="col-sm-4">
                <div class="card" data-aos="flip-left" data-aos-duration="2000" style="width:18rem;">
                    <img src="http://localhost/ujikom_avni/public/assets/img/<?= $pro['Foto']; ?>"
