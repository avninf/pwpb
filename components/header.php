...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="http://localhost/ujikom_avni/public/assets/img/apple-icon.png" />
    <link rel="icon" type="image/png" href="http://localhost/ujikom_avni/public/assets/img/favicon.png" />
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="http://localhost/ujikom_avni/public/assets/css/material-dashboard.css?v=3.0.0" rel="stylesheet" />
  </head>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
          <img src="../assets/img/a.jpg" class="navbar-brand-img h-100" alt="main_logo" />
          <span class="ms-1 font-weight-bold text-white">Avninf </span>
        </a>
      </div>
