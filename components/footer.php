...
<!--   Core JS Files   -->
<script src="http://localhost/ujikom_avni/public/assets/js/core/popper.min.js"></script>
    <script src="http://localhost/ujikom_avni/public/assets/js/core/bootstrap.min.js"></script>
    <script src="http://localhost/ujikom_avni/public/assets/js/plugins/perfect-scrollbar.min.js"></script>
    <script src="http://localhost/ujikom_avni/public/assets/js/plugins/smooth-scrollbar.min.js"></script>
    <script src="http://localhost/ujikom_avni/public/assets/js/plugins/chartjs.min.js"></script>
    <script>
